...
exports.default = function (_ref) {
	...
	var renderTools = function renderTools() {
		...
		return tools.map(function (item, index) {
			var X = index * 45;
			return target.group(target.rect(type === 'X' ? X : 0, type === 'Y' ? X : 0, 45, 45).attr({ class: 'WBToolsBG', fill: item._default_ ? selectFill : fill, fillOpacity: .4 }), target.image(item.icon, type === 'X' ? X + 10 : 10, type === 'Y' ? X + 10 : 10, 25, 25)).attr({
