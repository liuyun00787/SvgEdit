	...
	function Broadcaster(props) {
		...
		_this.initWBtools = function () {
			var _this$props = _this.props,
			    ...
			    width = _this$props$width === undefined ? 0 : _this$props$width,
			    _this$props$height = _this$props.height,
			    height = _this$props$height === undefined ? 0 : _this$props$height;
			...
			if (_this.wBToolsLayer) {
				...
				var _this$wBToolsLayer = _this.wBToolsLayer,
				    layer = _this$wBToolsLayer.layer,
...
Broadcaster.propTypes = {
	...
	onMouseChange: _propTypes2.default.func,
	onDrawChange: _propTypes2.default.func,
	onDeleteChange: _propTypes2.default.func,
	onWbToolsChange: _propTypes2.default.func,
