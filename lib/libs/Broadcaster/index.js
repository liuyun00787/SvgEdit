	...
	function Broadcaster(props) {
		...
		_this.init = function () {
			try {
				var that = _this;
				var role = _this.role;
				var _this$props$pptConfig = _this.props.pptConfig,
				    pptConfig = _this$props$pptConfig === undefined ? {} : _this$props$pptConfig;

				var svg = _this.svg = new _snapSvgMin2.default(_this.svgWrap);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'video',
					{
						...
						'data-setup': '{}' },
					_react2.default.createElement('source', { src: 'https://ppt-cdn.class100.com/ppts/766/G5L8_3.mp4', type: 'video/mp4' }),
					_react2.default.createElement(
						'p',
						{ className: 'vjs-no-js' },
